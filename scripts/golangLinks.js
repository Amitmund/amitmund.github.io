...
$(document).ready(function(){
	...
	$('#golangEnvironmentSetup').click(function(){
		$('#loadData').load('https://amitmund.github.io/blog/learnings/golang/golangEnvironmentSetup.html');
	});

	// and so on for rest of the links.
	$('#golangBuild').click(function(){
		$('#loadData').load('https://amitmund.github.io/blog/learnings/golang/golangBuild.html');
	 });

	// and so on for rest of the links.
	$('#golangVariables').click(function(){
		$('#loadData').load('https://amitmund.github.io/blog/learnings/golang/golangVariables.html');
	 });

	// and so on for rest of the links.
	$('#golangPackage').click(function(){
		$('#loadData').load('https://amitmund.github.io/blog/learnings/golang/golangPackage.html');
	});
